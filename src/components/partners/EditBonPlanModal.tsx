...
const EditBonPlanModal = ({ isOpen, onClose, bonPlan, onEditBonPlan, partenaires }: EditBonPlanModalProps) => {
  ...
  useEffect(() => {
    if (bonPlan) {
      setFormData({
        titre: bonPlan.titre,
        partenaire: bonPlan.partenaire,
        description: bonPlan.description,
        typeReduction: bonPlan.typeReduction,
        valeurReduction: bonPlan.valeurReduction,
        dateDebutReduction: bonPlan.dateDebutReduction,
        dateFinReduction: bonPlan.dateFinReduction,
        codePromo: bonPlan.codePromo,
        statut: bonPlan.statut,
      });
    }
  }, [bonPlan]);

  // Réinitialiser le pourcentage quand le type de réduction change vers gratuit
  useEffect(() => {
